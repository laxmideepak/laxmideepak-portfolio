...
export function ProjectCard({ project, index, showImage = false }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <Card className="group hover:border-primary transition-all duration-300 flex flex-col items-stretch justify-between shadow-md hover:shadow-xl p-0 bg-card/90 rounded-2xl border-2 border-transparent relative ring-4 ring-primary/60 glow h-full">
        {/* Project Image */}
        ...
        <div className="flex flex-col flex-1 justify-between p-6">
          ...
          <CardHeader className="pb-4 px-0">
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                <CardTitle className="text-xl font-bold text-foreground mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                  {project.title}
                </CardTitle>
          ...
          <CardContent className="px-0 pb-6 flex-1 flex flex-col justify-between">
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside text-foreground/90 text-sm space-y-1.5">
