...
function HeroSection() {
  ...
  return (
    <section id="hero" className="scroll-mt-24 min-h-[60vh] flex flex-col md:flex-row justify-center items-center text-center md:text-left relative space-y-6 mb-16">
      ...
      {/* Location Card - Mobile/Tablet Layout */}
      ...
      {position && hasPermission && (
        <div className="w-full max-w-sm mx-auto">
          <RemoteConnectionCTA
            ...
            onConnect={() => {
              window.open('mailto:laxmideepak2023@gmail.com?subject=Let\'s Connect!&body=Hi Laxmideepak, I saw your portfolio and would like to connect!', '_blank');
            }}
          />
        </div>
      )}
    ...
    <LocationProvider>
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        ...
        <div className="max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 pb-32 pt-32">
          ...
          {/* Hero Section with Location Card */}
          <HeroSection />
